...
export async function generateMetadata({ params }: LocaleLayoutProps): Promise<Metadata> {
  ...
  return {
    title: {
      ...
      default: 'OS² Commerce - Smart Shopify Apps That Work Together | Integrated E-commerce Ecosystem'
    },
    description: 'Transform your Shopify store with OS² Commerce - the only integrated suite of apps for order tracking, email marketing, and customer retention. Reduce costs by 30%, increase revenue by 40%. Start free.',
    ...
    openGraph: {
      ...
      title: 'OS² Commerce - Smart Shopify Apps That Work Together | Integrated E-commerce Ecosystem',
      description: 'Transform your Shopify store with OS² Commerce - the only integrated suite of apps for order tracking, email marketing, and customer retention. Reduce costs by 30%, increase revenue by 40%. Start free.',
      images: [
        {
          url: '/oss-logo.png',
    ...
    other: {
      ...
      'citation:title': 'OS² Commerce - Integrated Shopify App Ecosystem',
      'citation:author': 'OS² Commerce Team',
      'citation:publication': 'OS² Commerce Official Website',
      'citation:publisher': 'OS² Commerce',
