            ...
            <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto">
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardHeader className="p-8">
                  ...
                  <CardTitle className="text-2xl text-white text-center mb-4">Our Mission</CardTitle>
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardHeader className="p-8">
                  ...
                  <CardTitle className="text-2xl text-white text-center mb-4">Our Vision</CardTitle>
                  <p className="text-white/80 text-center leading-relaxed">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <div className="text-center p-6 bg-gradient-to-br from-white/5 to-white/2 rounded-lg backdrop-blur-sm">
                ...
                <h3 className="text-white font-semibold mb-2">Customer-Centric</h3>
                <p className="text-white/60 text-sm">Every decision starts with our merchants' success</p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-white/5 to-white/2 rounded-lg backdrop-blur-sm">
                ...
                <p className="text-white/60 text-sm">We push boundaries to solve real problems</p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-white/5 to-white/2 rounded-lg backdrop-blur-sm">
                ...
                <p className="text-white/60 text-sm">Quality and reliability in everything we build</p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-white/5 to-white/2 rounded-lg backdrop-blur-sm">
                ...
                <h3 className="text-white font-semibold mb-2">Empathy</h3>
                <p className="text-white/60 text-sm">We understand the challenges you face</p>
              </div>
            </div>
          </div>
        </section>
