            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardHeader className="p-8">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <CardTitle className="text-2xl text-white">Information Sharing and Disclosure</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-8 pt-0">
                  <div className="space-y-6 text-white/90">
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardHeader className="p-8">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <CardTitle className="text-2xl text-white">Data Security and Retention</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-8 pt-0">
                  <div className="space-y-6 text-white/90">
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardHeader className="p-8">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <CardTitle className="text-2xl text-white">Cookies and Tracking</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-8 pt-0">
                  <div className="space-y-4 text-white/90">
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h3 className="text-xl font-semibold text-white mb-4">Changes to This Privacy Policy</h3>
                  <p className="text-white/80">
