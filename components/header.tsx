      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <LocaleLink href="/apps" className="text-white/70 hover:text-[#F6B86C] transition-colors">
              {t('nav.ourApps')}
            </LocaleLink>
            <LocaleLink href="/blog" className="text-white/70 hover:text-[#F6B86C] transition-colors">
              {t('nav.blog')}
            </LocaleLink>
            <LocaleLink href="/about" className="text-white/70 hover:text-[#F6B86C] transition-colors">
              {t('nav.about')}
            </LocaleLink>
            <LocaleLink href="/support" className="text-white/70 hover:text-[#F6B86C] transition-colors">
              {t('nav.support')}
            </LocaleLink>
            <Button size="lg"
